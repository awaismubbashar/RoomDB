...
import com.example.roomdb.databinding.FragmentAddFragmentBinding

class AddFragment : Fragment() {

    private lateinit var mUserViewModel: UserViewModel
    private lateinit var binding: FragmentAddFragmentBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAddFragmentBinding.inflate(inflater, container, false)
